      ...
      {activePayrollSubView === 'Pay Slip' && (
        <div className="space-y-6 animate-in slide-in-from-bottom-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card title="Monthly Breakdown" className="flex flex-col h-auto sm:h-[420px] dark:bg-slate-900 dark:border-slate-800 p-0">
              ...
              <div className="p-4 sm:px-6 bg-slate-50 dark:bg-slate-800/50 border-t-2 border-slate-100 dark:border-slate-800 rounded-b-xl">
            ...
            <Card title="Bonuses & Festivals" className="flex flex-col h-auto sm:h-[420px] dark:bg-slate-900 dark:border-slate-800 p-0">
              <div className="p-4 sm:p-6 flex-1 overflow-y-auto custom-scrollbar">
                <div className="space-y-2">
