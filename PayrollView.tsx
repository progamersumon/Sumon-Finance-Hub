      ...
      {activePayrollSubView === 'Pay Slip' && (
        <div className="space-y-6 animate-in slide-in-from-bottom-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-4">
            <Card title="Monthly Breakdown" className="flex flex-col h-auto sm:h-[450px] dark:bg-slate-900 dark:border-slate-800 p-0 overflow-hidden">
              ...
              <div className="p-5 sm:px-6 pb-6 sm:pb-8 bg-slate-50 dark:bg-slate-800/50 border-t-2 border-slate-100 dark:border-slate-800 rounded-b-xl">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg sm:text-2xl font-black text-blue-700 dark:text-white">৳{(totalMonthly || 0).toLocaleString()}</span>
                </div>
              </div>
            </Card>
            <Card title="Bonuses & Festivals" className="flex flex-col h-auto sm:h-[450px] dark:bg-slate-900 dark:border-slate-800 p-0 overflow-hidden">
              <div className="p-4 sm:p-6 flex-1 overflow-y-auto custom-scrollbar">
                <div className="space-y-2">
              ...
              <div className="p-5 sm:px-6 pb-6 sm:pb-8 bg-slate-50 dark:bg-slate-800/50 border-t-2 border-slate-100 dark:border-slate-800 rounded-b-xl">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg sm:text-2xl font-black text-emerald-700 dark:text-white">৳{(totalYearlyBonus || 0).toLocaleString()}</span>
                </div>
              </div>
            </Card>
          </div>
