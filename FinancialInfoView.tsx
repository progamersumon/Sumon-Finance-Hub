              ...
              {selectedMonth === 'all' ? (
                ...
                breakdownData.length > 0 ? (
                  <div className="h-[450px] sm:h-[550px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie data={breakdownData} cx="50%" cy="50%" innerRadius={80} outerRadius={130} paddingAngle={1} dataKey="value" labelLine={false} label={renderCustomizedLabel}>
                ...
                ) : <div className="h-[450px] flex items-center justify-center text-slate-400 italic">No expenses recorded for this period.</div>
              )}
            </Card>

            <Card title="Expense Breakdown" className="dark:bg-slate-900 dark:border-slate-800">
              <div className="space-y-4 max-h-[450px] sm:max-h-[550px] overflow-y-auto custom-scrollbar pr-2">
                {breakdownData.length > 0 ? (
